package cn.wujiangbo.utils.sign;
...
public class Md5Utils {
     ...
     *    同 MD5Lower() 一样
     */
    public final static String getPassword(String plainText) {
        try {
    ...
    public static boolean valid(String text, String md5) {
        return md5.equals(getPassword(text)) || md5.equals(getPassword(text).toUpperCase());
    }
    ...
    public static void main(String[] args) {
        String plainText = "15";
        System.out.println(getPassword(plainText));
        System.out.println(getPassword(plainText));
        System.out.println(getPassword(plainText));
        System.out.println(getPassword(plainText));
    }

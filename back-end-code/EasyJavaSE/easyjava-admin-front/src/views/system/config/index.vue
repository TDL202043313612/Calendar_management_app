<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item>
        <el-button type="primary" icon="el-icon-search" size="mini" v-hasPermi="['easyConfig:pagelist']" @click="handleQuery">搜索</el-button>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['easyConfig:deleteBatch']"
        >删除</el-button>
      </el-col>
      <!--<el-col :span="1.5">
        <el-button
    ...
    <el-table border v-loading="loading" :height="tableMaxHeight" :data="configList" @selection-change="handleSelectionChange" ref="objectTable">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="参数名称" prop="configName" :show-overflow-tooltip="true" />
      <el-table-column label="参数键名" prop="configKey" :show-overflow-tooltip="true" width="180"/>
      <el-table-column label="参数键值" prop="configValue" width="200"/>
      <el-table-column label="系统内置" prop="configType" width="90">

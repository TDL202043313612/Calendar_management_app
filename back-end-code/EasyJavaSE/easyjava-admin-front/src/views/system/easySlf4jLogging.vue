<template>
  <div class="app-container">
    ...
    <el-table :height="tableMaxHeight" :cell-style="rowStyle" stripe border v-loading="loading" :data="tableDataList" @selection-change="handleSelectionChange" ref="objectTable">
      ...
      <el-table-column prop="logLevel" :show-overflow-tooltip="true" width="160" label="日志级别">
      </el-table-column>

      <el-table-column prop="logContent" :show-overflow-tooltip="true" width="160" label="日志内容">
      </el-table-column>

      <el-table-column prop="logTime" :show-overflow-tooltip="true" width="160" label="日志时间">
      </el-table-column>

      <el-table-column prop="logMethod" :show-overflow-tooltip="true" width="160" label="日志方法">
      </el-table-column>

      <el-table-column prop="logClass" :show-overflow-tooltip="true" width="160" label="日志类路径">
      </el-table-column>

      <el-table-column prop="logLine" :show-overflow-tooltip="true" width="160" label="日志行数">
      </el-table-column>

      <el-table-column prop="logThread" :show-overflow-tooltip="true" width="160" label="日志线程">
      </el-table-column>

      <el-table-column prop="createTime" :show-overflow-tooltip="true" width="160" label="创建时间">
      </el-table-column>

      <el-table-column prop="createUserName" :show-overflow-tooltip="true" width="160" label="创建人">
      </el-table-column>

      <el-table-column prop="updateTime" :show-overflow-tooltip="true" width="160" label="更新时间">
      </el-table-column>

      <el-table-column prop="updateUserName" :show-overflow-tooltip="true" width="160" label="更新人">
      </el-table-column>

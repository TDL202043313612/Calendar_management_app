<template>
  <div class="app-container">
    ...
    <el-table border v-loading="loading" :height="tableMaxHeight" :data="dataList" @selection-change="handleSelectionChange" ref="objectTable">
      ...
      <el-table-column label="更新人" align="center" prop="createUserName" width="120">
      </el-table-column>
